...
trf = classTranf(src_vocab_size, tgt_vocab_size, d_model, num_heads, num_layers, d_ff, max_seq_length, dropout)
...
optimizer = optim.Adam(trf.parameters(), lr = 0.0001, betas=(0.9, 0.98), eps = 1e-9)

trf.train()
for epoch in range(100):
    optimizer.zero_grad()
    output = trf(src_data, tgt_data[:,:-1])
